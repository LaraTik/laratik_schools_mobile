...
// Typed failure for the Teachers feature (My classes + class
// detail + exam authoring + manual grading).
//
...
// per-field errors (e.g. the future "create teaching assignment"
// form).

import 'package:equatable/equatable.dart';

class TeachersFailure extends Equatable implements Exception {
  ...
  /// `TEACHING_ASSIGNMENT_NOT_FOUND`, `NETWORK_FAILURE`,
  ...
  /// read-only "My classes" surface today, but the field is here
  /// so the shape stays consistent with PersonFailure and a
  /// future "create teaching assignment" form can drop in
  ...
  @override
  String toString() => 'TeachersFailure($code): $message';
