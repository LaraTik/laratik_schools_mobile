...
class _QuickStartGrid extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final items = <_QuickItem>[
      ...
      if (canManageBranches)
        _QuickItem(
          label: l.homeAdminGovernance,
          description: l.homeAdminGovernanceSubtitle,
          icon: Icons.privacy_tip_outlined,
          tone: LsChipTone.warning,
          onTap: () => context.go('/shell/governance'),
        ),
      if (canManageBranches)
        _QuickItem(
          label: l.homeAdminGrading,
          description: l.homeAdminGradingSubtitle,
